...
DATASET_GROUP = "chat"
METRICS_TYPE = "loft"
DEFAULT_EVAL_ARGS = "++eval_type=loft ++eval_config.metrics=mrecall_at_k ++eval_config.k=3"
DEFAULT_GENERATION_ARGS = "++input_file=/loft/128k/retrieval_quest/test.jsonl ++dataset=null ++split=null"
